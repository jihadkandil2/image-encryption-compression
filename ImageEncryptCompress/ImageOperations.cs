...
namespace ImageEncryptCompress
{
    ...
    public class ImageOperations
    {
        ...
        public static bool CompareTwoImages(RGBPixel[,] Image1, RGBPixel[,] Image2)
        {
            int FirstImageHeight = ImageOperations.GetHeight(Image1);
            int FirstImageWidth = ImageOperations.GetWidth(Image1);
            int SecondImageHeight = ImageOperations.GetHeight(Image2);
            int SecondImageWidth = ImageOperations.GetWidth(Image2);
